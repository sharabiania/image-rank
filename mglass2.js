 ...
 * @version 1.1
 * @author Ali Sharabiani 2018-09-21
 * @version 1.2
...
function MGlass2(imageId1, imageId2, largeImageSrc1, largeImageSrc2, configObject){
	...
	this.updateSrc = function(src1, src2) {
		this.largeImage1 = new Image();
		this.largeImage1.src = src1;
		this.largeImage2 = new Image();
		this.largeImage2.src = src2;	
...
//	pictureBoxElement.style.width = this.smallImage1.width + this.smallImage2.width + 50 + "px";
